...
/// <c>RedisEvents.Extensions.StreamsBuilderExtensions.Core</c>. It lives here, and not in the
...
{
    private const string RegisteredKey = "RedisEvents.Web:HealthCheck";
