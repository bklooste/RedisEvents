...
> [`library/tst/Orange.Lib.Streams.UnitTests/ReadmeSamples.cs`](../../tst/Orange.Lib.Streams.UnitTests/ReadmeSamples.cs).
...
reading `!! Orange.Lib.Streams: this batch array was returned to the pool !!` rather than as garbage.
