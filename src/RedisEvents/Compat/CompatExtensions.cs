...
/// <summary>
/// The Kafka-era registration calls, backed by RedisEvents. Registering a consumer through
...
/// <c>Orange.Lib.Kafka.Aot</c> → <c>RedisEvents</c> — plus configuration, plus (in
...
/// </para>
/// <para>
/// <b>A service references either <c>Orange.Lib.Kafka.Aot</c> or <c>RedisEvents</c>, never
...
public static class CompatExtensions
{
    ...
    /// <exception cref="RedisEvents.Errors.StreamConfigurationException">
