...
/// unchanged against RedisEvents. See <see cref="EventMsg"/> for what the shim costs and for
/// the behaviour differences a handler has to be checked against.
/// </para>
/// <para>
/// A service references either <c>Orange.Lib.Kafka.Aot</c> or <c>RedisEvents</c>, never both:
...
public interface IBatchConsumer
{
    ...
    /// resolved, throw a subclass of <see cref="RedisEvents.Errors.DontIgnoreException"/> instead
