...
/// <summary>
/// One-call OpenTelemetry wiring for RedisEvents, in the shape of the
...
/// <see cref="System.Diagnostics.Metrics.Meter"/> are both named <c>RedisEvents</c> and are
...
public static class OpenTelemetryExtensions
{
    ...
    public static TracerProviderBuilder AddRedisEvents(this TracerProviderBuilder builder)
    {
    ...
    /// <returns>The same builder, for chaining.</returns>
    public static MeterProviderBuilder AddRedisEvents(this MeterProviderBuilder builder)
    {
        ArgumentNullException.ThrowIfNull(builder);
