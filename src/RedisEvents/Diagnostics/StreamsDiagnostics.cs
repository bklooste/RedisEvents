...
/// <summary>
/// The single <see cref="ActivitySource"/> and <see cref="Meter"/> for RedisEvents, plus
...
internal static class StreamsDiagnostics
{
    ...
    /// <c>AddSource</c>/<c>AddMeter</c>, or use <c>AddRedisEvents()</c>.
    /// </summary>
    internal const string SourceName = "RedisEvents";
