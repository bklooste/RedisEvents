...
/// with <c>RedisEvents.EventSourcing.Tests</c>), each consuming test assembly still needs this
/// one-line registration of its own. See the remarks on <see cref="RedisStreamsCollection"/> for why.
/// </remarks>
